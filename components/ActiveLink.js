...
const ActiveLink = ({ href, children, ...rest }) => {
    ...
    const currentTheme = mounted && theme !== undefined && theme === 'system' ? systemTheme : theme;

    const activeLinkBgColor = currentTheme === 'dark'
        ? 'bg-gray-700 text-white'
        : 'bg-purple-600 text-white';

    const themeBgHover = currentTheme === 'dark'
