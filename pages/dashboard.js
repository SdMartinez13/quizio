export default function Home() {
    return (
        <>
            <p className="text-gray-700 text-3xl mb-16 font-bold">Dashboard Under Construction</p>
...
// const Dashboard = () => {
//     const b = '';
//     return <div className="flex justify-center bold">Dashboard under construction</div>;
